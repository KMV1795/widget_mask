  ...
  Widget build(BuildContext context) {
    ...
    return DemoCard(
      child: NegativeMaskedImage(
        ...
        image: const AssetImage('assets/images/icons8-musical-notes-100.png'),
      ),
    );
  }
}
    ...
    child: Container(
      ...
      child: Center(
        child: ImageFilledText(
          ...
          image: const AssetImage('assets/images/peacock.jpg'),
        ),
      ),
    ),
  );
...
class NegativeMaskedImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => WidgetMask(
    ...
    mask: mask,
    child: const Image(
      image: AssetImage('assets/images/peacock.jpg'),
      fit: BoxFit.cover,
    ),
  );
}
